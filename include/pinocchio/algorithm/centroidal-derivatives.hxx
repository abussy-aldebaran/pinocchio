...
namespace pinocchio
{
  namespace impl
  {
    ...
    : public fusion::JointUnaryVisitorBase<CentroidalDynDerivativesForwardStep<
        Scalar,
        Options,
        JointCollectionTpl,
        ConfigVectorType,
    ...
    : public fusion::JointUnaryVisitorBase<
        CentroidalDynDerivativesBackwardStep<Scalar, Options, JointCollectionTpl>>
    {
      typedef ModelTpl<Scalar, Options, JointCollectionTpl> Model;
      typedef DataTpl<Scalar, Options, JointCollectionTpl> Data;
  ...
  namespace
  {
    ...
    void translateForceSet(
      const Eigen::MatrixBase<Matrix6xLikeIn> & Fin,
  ...
  namespace impl
  {
      ...
      const Eigen::MatrixBase<Matrix6xLike3> & dhdot_da)
    {
      ...
      typedef CentroidalDynDerivativesForwardStep<
    ...
    : public fusion::JointUnaryVisitorBase<
        GetCentroidalDynDerivativesBackwardStep<Scalar, Options, JointCollectionTpl>>
    {
      typedef ModelTpl<Scalar, Options, JointCollectionTpl> Model;
      typedef DataTpl<Scalar, Options, JointCollectionTpl> Data;
  ...
  void computeCentroidalDynamicsDerivatives(
    ...
    const Eigen::MatrixBase<Matrix6xLike3> & dhdot_da)
  {
    impl::computeCentroidalDynamicsDerivatives(
      model, data, make_const_ref(q), make_const_ref(v), make_const_ref(a), make_ref(dh_dq),
      make_ref(dhdot_dq), make_ref(dhdot_dv), make_ref(dhdot_da));
  }
    ...
    const Eigen::MatrixBase<Matrix6xLike3> & dhdot_da)
  {
    impl::getCentroidalDynamicsDerivatives(
      model, data, make_ref(dh_dq), make_ref(dhdot_dq), make_ref(dhdot_dv), make_ref(dhdot_da));
  }
