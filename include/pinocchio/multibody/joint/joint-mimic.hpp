...
namespace pinocchio
{
  template<typename _Scalar, int _Options> struct ScaledJointMotionSubspaceTpl;
  ...
  struct traits< ScaledJointMotionSubspaceTpl<_Scalar, _Options> >
  {
    ...
    enum { Options = traits<RefJointMotionSubspace>::Options };
    enum {
  ...
  { typedef typename SE3GroupAction<typename traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace>::ReturnType ReturnType; };
  ...
  { typedef typename MotionAlgebraAction<typename traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace, MotionDerived>::ReturnType ReturnType; };
  ...
  {
    typedef typename traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace::Scalar Scalar;
    // typedef typename ConstraintForceOp<typename traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace,ForceDerived>::ReturnType OriginalReturnType;
    ...
    typedef Eigen::Matrix<Scalar,IdealReturnType::RowsAtCompileTime,IdealReturnType::ColsAtCompileTime,traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace::Options> ReturnType;
  };
  ...
  {
    typedef typename traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace::Scalar Scalar;
    // typedef typename ConstraintForceSetOp<typename traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace, ForceSet>::ReturnType OriginalReturnType;
    typedef Eigen::Matrix<_Scalar, Eigen::Dynamic, Eigen::Dynamic, _Options> OriginalReturnType;
    typedef typename ScalarMatrixProduct<Scalar,OriginalReturnType>::type IdealReturnType;
    typedef Eigen::Matrix<Scalar,traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace::NV,ForceSet::ColsAtCompileTime, traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace::Options | Eigen::RowMajor> ReturnType;
  };
  ...
  : JointMotionSubspaceBase< ScaledJointMotionSubspaceTpl<_Scalar, _Options> >
  {
    ...
    enum { NV = Eigen::Dynamic};
    typedef JointMotionSubspaceBase<ScaledJointMotionSubspaceTpl> Base;
    using Base::nv;
    
    typedef typename traits<ScaledJointMotionSubspaceTpl<_Scalar, _Options>>::RefJointMotionSubspace RefJointMotionSubspace;
    ...
    ScaledJointMotionSubspaceTpl(const RefJointMotionSubspace & constraint,
    ...
    struct TransposeConst
    {
      ...
      TransposeConst(const ScaledJointMotionSubspaceTpl & ref) : ref(ref) {}
      ...
      operator*(const ForceDense<Derived> & f) const
      {
        ...
        typedef typename ConstraintForceOp<ScaledJointMotionSubspaceTpl,Derived>::ReturnType ReturnType;
      ...
      {
        typedef typename ConstraintForceSetOp<ScaledJointMotionSubspaceTpl,Derived>::ReturnType ReturnType;
        return ReturnType(ref.m_scaling_factor * (ref.m_constraint.transpose() * F));
      }
    ...
    {
      typedef typename MotionAlgebraAction<ScaledJointMotionSubspaceTpl,MotionDerived>::ReturnType ReturnType;
    ...
    inline const RefJointMotionSubspace & constraint() const { return m_constraint.derived(); }
    inline RefJointMotionSubspace & constraint() { return m_constraint.derived(); }
  ...
  struct MultiplicationOp<InertiaTpl<S1,O1>, ScaledJointMotionSubspaceTpl<S2, O2> >
  {
    ...
    // typedef typename MultiplicationOp<Inertia,typename Constraint::RefConstraint>::ReturnType OriginalReturnType;
...
struct TransferVisitor : public boost::static_visitor<void> {
  ...
  : public JointDataBase< JointDataMimicTpl<_Scalar, _Options, JointCollectionTpl> >
  {
    ...
    static std::string classname() {  return std::string("JointDataMimic"); }
    ...
    TansformTypeRef M_accessor() {
      // assert(false && "Changes to non const ref on mimic joints won't be taken into account. Use const ref");
      M_ = m_jdata_ref.M();
      return M_; }
    ...
    const RefJointData & jdata() const { return m_jdata_ref; }
    RefJointData & jdata() { return m_jdata_ref; }
    
    const Scalar & scaling() const { return m_scaling; }
    Scalar & scaling() { return m_scaling; }
    
    ConfigVector_t & joint_q_accessor() { return m_q_transform; }
    const ConfigVector_t & joint_q_accessor() const { return m_q_transform; }
    
    TangentVector_t & joint_v_accessor() { return m_v_transform; }
    const TangentVector_t & joint_v_accessor() const { return m_v_transform; }
  ...
  : public JointModelBase< JointModelMimicTpl<_Scalar,_Options,JointCollectionTpl> >
  {
              ...
              const typename Eigen::MatrixBase<ConfigVector> & qs) const
    {
      ...
      AffineTransform::run(qs.segment(m_jmodel_ref.idx_q(), m_jmodel_ref.nq()),
    ...
    {
      // TODO: fixme
      assert(false && "Joint Mimic is not supported for aba yet. Remove it from your model if you want to use this function");
    ...
    static std::string classname() { return std::string("JointModelMimic"); }
...
namespace boost
{
  ...
  struct has_nothrow_constructor< ::pinocchio::JointModelMimicTpl<Scalar,Options,JointCollectionTpl> >
  ...
  template<typename Scalar, int Options, template<typename S, int O> class JointCollectionTpl>
  struct has_nothrow_constructor< ::pinocchio::JointDataMimicTpl<Scalar,Options,JointCollectionTpl> >
  : public integral_constant<bool,true> {};
